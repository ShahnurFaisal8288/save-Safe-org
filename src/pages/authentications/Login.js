                        ...
                        <div className="col-lg-4 mx-auto">
                            <div className="auth-form-light text-left p-5">
                                <div className="brand-logo">
                                    <img src="https://demo.bootstrapdash.com/stellar-admin-new/themes/assets/images/logo-dark.svg" alt="logo" />
                                </div>
                                <h4>Hello! let's get started</h4>
                                <h6 className="font-weight-light">Sign in to continue.</h6>
                                <form className="pt-3" onSubmit={handleSubmit(onSubmit)}>
                                    <div className="form-group">
                                        <input type="text" {...register("emailOrPhone", { required: true })} className="form-control form-control-lg" placeholder="Email or Phone" />
                                        {errors.emailOrPhone && <p style={{ color: "red" }}>Email or Phone is required</p>}
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="mt-3">
                                        <button type="submit" disabled={loading} className="btn d-grid btn-primary btn-lg font-weight-medium auth-form-btn">{loading ? "Logging in..." : "Login"}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
